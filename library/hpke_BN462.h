 ...
 */
extern int DeriveKeyPair_BN462(int config_id,octet *SK,octet *PK,octet *SEED);
 ...
 */
extern void HPKE_BN462_Encap(int config_id,octet *SK,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_BN462_Decap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR);
 ...
 */
extern void HPKE_BN462_AuthEncap(int config_id,octet *skE,octet *skS,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 *
    ...
    @param pkS the Initiators public key
 */
extern void HPKE_BN462_AuthDecap(int config_id,octet *skR,octet *Z,octet *pkE,octet *pkR,octet *pkS);
 ...
 */
extern void HPKE_BN462_KeySchedule(int config_id,octet *key,octet *nonce,octet *exp_secret,int mode,octet *Z,octet *info,octet *psk,octet *pskID);
